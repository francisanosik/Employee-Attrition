...
automl_run_id = 'AutoML_efea9cd6-29fa-4349-ba5b-d9f0fcd04520_20'
...
def generate_data_transformation_config():
    ...
    column_group_0 = ['Age', 'Job Role', 'Work-Life Balance', 'Job Satisfaction', 'Performance Rating', 'Number of Promotions', 'Education Level', 'Marital Status', 'Number of Dependents', 'Job Level', 'Company Size', 'Company Reputation', 'Employee Recognition']
    
    column_group_1 = ['Gender', 'Overtime', 'Remote Work', 'Leadership Opportunities', 'Innovation Opportunities']
    
    column_group_2 = [['Years at Company'], ['Monthly Income'], ['Distance from Home'], ['Company Tenure']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_id', type=str, default='6f5edd0a-75cd-4e18-a802-617a4b83c775',     help='Default training dataset id is populated from the parent run')
